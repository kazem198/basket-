        ...
        for i, (posX, posY) in enumerate(zip(posListX, posListY)):
            ...
            if i == 0:
                ...
                cv2.line(imgContours, pos,
                         (posListX[i - 1], posListY[i - 1]), (0, 255, 0), 5)
...
# cap = cv2.VideoCapture('Videos/vid (4).mp4')
# myColorFinder = ColorFinder(False)
# hsvVals = {'hmin': 8, 'smin': 124, 'vmin': 13,
...
#                 else:
#                     cv2.line(
#                         imgCon, (posListX[i - 1], posListY[i - 1]), pos, (0, 255, 0), 2)
#                     cv2.line(
#                         imgResult, (posListX[i - 1], posListY[i - 1]), pos, (0, 255, 0), 2)
